...
function M.setup(c, config)
	...
	local essential_groups = {
		...
		RenderMarkdownH1Bg = { bg = c.base_04, fg = c.base_13, bold = true },
		RenderMarkdownH2Bg = { bg = c.base_03, fg = c.base_13, bold = true },
		RenderMarkdownH3Bg = { bg = c.base_02, fg = c.base_13, bold = true },
		RenderMarkdownH4Bg = { bg = c.base_01, fg = c.base_13, bold = true },
		RenderMarkdownH5Bg = { bg = c.base_01, fg = c.base_13, bold = true },
		RenderMarkdownH6Bg = { bg = c.base_01, fg = c.base_13, bold = true },
